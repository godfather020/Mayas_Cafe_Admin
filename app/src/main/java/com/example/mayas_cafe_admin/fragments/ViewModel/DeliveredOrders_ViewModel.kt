...
class DeliveredOrders_ViewModel : ViewModel() {
    ...
    fun getDeliveredOrders(activity : Fragment, token : String, loading : ProgressBar) : MutableLiveData<Response_Common> {
        ...
        getDeliveredOrdersFromAPI(request_branch)

        return commonResponse
    }

    private fun getDeliveredOrdersFromAPI(param: Request_Branch) {
