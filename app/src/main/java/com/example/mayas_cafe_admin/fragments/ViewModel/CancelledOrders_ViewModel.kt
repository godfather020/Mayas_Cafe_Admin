...
class CancelledOrders_ViewModel : ViewModel() {
    ...
    fun getCancelledOrders(activity : Fragment, token : String, loading : ProgressBar) : MutableLiveData<Response_Common> {
        ...
        getCancelledOrdersFromAPI(request_branch)

        return commonResponse
    }

    private fun getCancelledOrdersFromAPI(param: Request_Branch) {
