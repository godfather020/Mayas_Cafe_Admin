...
class ReadyToPickUp_ViewModel : ViewModel() {
    ...
    fun getReadyToPickUp(activity : Fragment, token : String, loading : ProgressBar) : MutableLiveData<Response_Common> {
        ...
        getReadyOrdersFromAPI(request_branch)

        return commonResponse
    }

    private fun getReadyOrdersFromAPI(param: Request_Branch) {
