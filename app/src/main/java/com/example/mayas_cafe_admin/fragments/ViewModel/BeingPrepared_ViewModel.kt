...
class BeingPrepared_ViewModel : ViewModel() {
    ...
    fun getBeingPrepared(activity : Fragment, token : String, loading : ProgressBar) : MutableLiveData<Response_Common> {
        ...
        getPrepareOrdersFromAPI(request_branch)

        return commonResponse
    }

    private fun getPrepareOrdersFromAPI(param: Request_Branch) {
