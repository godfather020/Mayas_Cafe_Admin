...
class AllTransaction_ViewModel : ViewModel() {
    ...
    fun getAllOrders(activity : Fragment, token : String, loading : ProgressBar) : MutableLiveData<Response_Common> {
        ...
        getAllOrdersFromAPI(request_branch)
...
//               TODO("Not yet implemented")
    ...
    private fun getAllOrdersFromAPI(param: Request_Branch) {
