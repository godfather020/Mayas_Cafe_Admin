...
class CategoryItemsViewModel : ViewModel() {
    ...
    fun getCategoryProducts(activity : Fragment, token : String, categoryId : String, loading : ProgressBar) : MutableLiveData<Response_Common>{
        ...
        requestCategory.categoryId = categoryId

        getCategoryProductsFromAPI(requestCategory)

        return commonResponse
    }

    private fun getCategoryProductsFromAPI(param: Request_CategoryDetails) {
