...
class CancelledOrder_frag : Fragment() {
    ...
    private fun setUpCancelledOrderRv() {
        ...
        recycleView_models.add(RecycleModel("#4545","9:40 PM", "$9", "Cancelled", "4", "adsadsa"))
        recycleView_models.add(RecycleModel("#4545","8:30 PM", "$4", "Cancelled", "4", "adsadsa"))
        recycleView_models.add(RecycleModel("#4545","7:50 PM", "$7", "Cancelled", "4", "adsadsa"))
