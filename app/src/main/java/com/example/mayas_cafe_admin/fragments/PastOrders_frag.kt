...
class PastOrders_frag : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = PastOrders_frag.CustomViewAdapter(childFragmentManager)

        adapter.addFragment(DeliveredOrders_frag(), "Delivered Orders")
        adapter.addFragment(CancelledOrder_frag(), "Cancelled Orders")
