...
class ActiveOffers : Fragment() {
    ...
    lateinit var loadingActiveO: ProgressBar
    ...
    override fun onCreateView(
        ...
        loadingActiveO = view.findViewById(R.id.loading_activeO)
        loadingActiveO.visibility = View.VISIBLE
    ...
    private fun getActiveOffers() {

        if (token != null) {

            activeOffersViewModel.getActiveOffers(this, token.toString(), loadingActiveO)
                .observe(viewLifecycleOwner) {
                    ...
                    if (it != null) {
                        ...
                        if (it.getSuccess()!!) {
                            ...
                            loadingActiveO.visibility = View.GONE
                            setUpActiveOffersRv()
                        }
                    }
                }
