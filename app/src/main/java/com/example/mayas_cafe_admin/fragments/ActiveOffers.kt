...
class ActiveOffers : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_active_offers, container, false)

        recyclerView= view.findViewById(R.id.activeOffers_rv)
    ...
    private fun setUpActiveOffersRv() {

        recycleView_models.clear()

        recycleView_models.add(RecycleModel("40%","sadads", "Porridge", "Flat discount on every purchase, Flat discount on every purchase, Flat discount on every purchase, Flat discount on every purchase", " Offer available only 21 to 23 April Offer available only 21 to 23 April Offer available only 21 to 23 April"))
