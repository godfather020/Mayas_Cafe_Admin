...
public class RecycleView_RTP extends RecyclerView.Adapter<RecycleView_RTP.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull RecycleView_RTP.MyViewHolder holder, int position) {
        ...
        holder.completeOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showDialog(holder.getAbsoluteAdapterPosition(), "Order is moved to Delivered", "Order Complete");
    ...
    private void updateOrderStatus(int position) {
        ...
        request_updateOrder.setOrderStatus("5");
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            completeOrder = itemView.findViewById(R.id.readyOrderApprove);
            payStatus = itemView.findViewById(R.id.payStatus_rtp);
        }
    }
}
