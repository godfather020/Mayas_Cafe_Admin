...
public class RecycleView_BP extends RecyclerView.Adapter<RecycleView_BP.MyViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull RecycleView_BP.MyViewHolder holder, int position) {
        ...
        holder.moveOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showDialog(holder.getAbsoluteAdapterPosition(), "Order moved to ready to pickup", "Ready to PickUp");
            }
        });
    ...
    private void updateOrderStatus(int position) {
        ...
        request_updateOrder.setOrderStatus("3");
    ...
    private void showDialog(int absoluteAdapterPosition, String order_msg, String order_status) {
        ...
        orderStatus.setTextColor(context.getResources().getColor(R.color.Green));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            moveOrder = itemView.findViewById(R.id.beingPreOrderApprove);
            payStatus = itemView.findViewById(R.id.payStatus_bp);
        }
    }
}
