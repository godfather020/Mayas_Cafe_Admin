...
public class RecycleView_NT extends RecyclerView.Adapter<RecycleView_NT.MyViewHolder>{

    Context context;
    ArrayList<RecycleModel> foodModels4;

    public RecycleView_NT(Context context, ArrayList<RecycleModel> foodModels4){
    ...
    @NonNull
    @Override
    public RecycleView_NT.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Inflate the layout (Giving look)
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.today_notify_rv, parent, false);
        return new RecycleView_NT.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleView_NT.MyViewHolder holder, int position) {
